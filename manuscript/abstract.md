...
for exact cross-view imputation and other latent space manipulations.
Evaluations and illustrations on both imaging-derived phenotypes (IDPs) and
multimodal MRI demonstrate the proposed framework and potential applications
such as anatomically-detailed interpolative reconstructions which, for example,
facilitate traditional image registration scenarios. To further motivate our
work, we provide a robust and comprehensive, 2D- and 3D-capable open-source
