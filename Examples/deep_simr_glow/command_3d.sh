...
SCREEN_METHOD=none           # none | cca | hsic
...
aug_params_phase1="\
noise_std:cos:0.025->0.008@${total},\
sd_affine:cos:0.03->0.00@$((total*3/5)),\
sd_deformation:linear:6.0->1.0@$((total*7/10)),\
sd_simulated_bias_field:cos:0.10->0.03@${total},\
sd_histogram_warping:cos:0.02->0.008@${total}"
